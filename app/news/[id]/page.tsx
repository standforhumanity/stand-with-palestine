...
const newsArticles = [
  {
    ...
    content: `
      ...
      <p>The international community has called for immediate and unhindered access for humanitarian aid to Gaza. Several countries have pledged additional funding for relief efforts, but aid workers report that the main obstacle is not funding but access.
      </p>
    ...
    featured: true,
    relatedArticles: ["un-resolution-palestine", "international-solidarity-movement"],
  },
  {
    ...
    authorBio:
      "Mohammed Khalil is a political analyst specializing in international law and Middle Eastern politics. He has written extensively on UN resolutions related to Palestine and their implementation.",
    category: "Politics",
    relatedArticles: ["gaza-humanitarian-crisis", "international-solidarity-movement"],
  },
  {
    ...
    category: "Media",
    relatedArticles: ["palestinian-cultural-resistance", "international-solidarity-movement"],
  },
  {
    ...
    relatedArticles: ["gaza-humanitarian-crisis", "un-resolution-palestine"],
  },
  {
    ...
    category: "Culture",
    relatedArticles: ["media-coverage-bias", "palestinian-resistance-history"],
  },
  {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/news">
            <Button className="bg-palestine-green hover:bg-palestine-green/90">Return to News</Button>
          </Link>
        </div>
      </div>
    )
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-6">
            <Link href="/news" className="text-palestine-green hover:underline flex items-center gap-2">
              <svg
          ...
          <Badge className="mb-4 bg-palestine-green">{article.category}</Badge>
          <h1 className="text-3xl md:text-4xl font-bold mb-4 text-palestine-green">{article.title}</h1>
                ...
                {relatedArticles.map((relatedArticle) => (
                  ...
                  >
                    ...
                    <div className="p-4">
                      ...
                      <h3 className="text-lg font-bold mb-2 text-palestine-green">{relatedArticle.title}</h3>
